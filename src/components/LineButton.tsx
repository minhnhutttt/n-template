  ...
  return (
    <div className="px-5">
      <div className="w-full max-w-[510px] mx-auto">
        <div className="md:text-[clamp(1px,1.636vh,18px)] text-[14px] bg-[#101541] rounded-2xl text-center text-white relative p-1.5 mb-[clamp(1px,2.545vh,28px)]">
        ...
        <div className="w-full flex justify-center h-[124px] md:h-[clamp(1px,11.273vh,124px)]">
            <a href="https://lin.ee/RFM7pae" target="_blank" className="w-full max-w-[510px] h-[115px] md:h-[clamp(1px,10.455vh,115px)] gap-3 relative rounded-[24px] md:text-[clamp(1px,2.545vh,28px)] text-[20px] text-white font-black bg-bg-line flex items-center justify-center hover:border-b border-b-[9px] hover:mt-[8px] border-[#005800] duration-200 tracking-[0.2em]">
