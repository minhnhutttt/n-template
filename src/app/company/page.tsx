export default function Company() {
  return (
    <main>
      <div className="h-[240px] u-bg-gradient-01 flex justify-center pt-[108px] md:w-[550px]">
        <p className="md:text-[36px] text-[24px] text-white font-semibold">会社概要</p>
      </div>
      <div className="pt-10 px-4 md:pb-[200px] pb-[100px]">
            <div>
                <p className="h-[60px] flex items-center justify-center bg-[#43ABFC] text-white md;text-[20px] text-[18px]">会社名</p>
                <p className="text-center p-5 md:p-[30px] md:text-[20px] text-[18px] font-light">
                    株式会社 Good Fellows
                </p>
            </div>
            <div>
                <p className="h-[60px] flex items-center justify-center bg-[#43ABFC] text-white md;text-[20px] text-[18px]">設立年月日</p>
                <p className="text-center p-5 md:p-[30px] md:text-[20px] text-[18px] font-light">
                    2011年8月9日
                </p>
            </div>
            <div>
                <p className="h-[60px] flex items-center justify-center bg-[#43ABFC] text-white md;text-[20px] text-[18px]">資本金</p>
                <p className="text-center p-5 md:p-[30px] md:text-[20px] text-[18px] font-light">
                500万円
                </p>
            </div>
            <div>
                <p className="h-[60px] flex items-center justify-center bg-[#43ABFC] text-white md;text-[20px] text-[18px]">所在地</p>
            ...
            <div>
                <p className="h-[60px] flex items-center justify-center bg-[#43ABFC] text-white md;text-[20px] text-[18px]">電話番号</p>
                <p className="text-center p-5 md:p-[30px] md:text-[20px] text-[18px] font-light">
                03-6824-8280
                </p>
            </div>
            <div>
                <p className="h-[60px] flex items-center justify-center bg-[#43ABFC] text-white md;text-[20px] text-[18px]">社員数</p>
                <p className="text-center p-5 md:p-[30px] md:text-[20px] text-[18px] font-light">
                10名
                </p>
            </div>
            ...
            <div>
                <p className="h-[60px] flex items-center justify-center bg-[#43ABFC] text-white md;text-[20px] text-[18px]">会社の目的</p>
